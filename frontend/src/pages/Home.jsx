...
<HighlightText text={"Real-World Tech Skills"} />
                    </motion.div>
                    ...
                    >
                        Learn practical tech skills at your own pace, build real projects, and get the confidence to start your career in software development, freelancing, or internships.
                    </motion.div>
                        ...
                        <CodeBlocks
                            ...
                            heading={
                                <div className='text-3xl lg:text-4xl font-semibold'>
                                    Unlock Your
<HighlightText text={"Programming Potential"} />
with Hands-on Learning
                                </div>
                            }
                            subheading={
                                "Our courses are focused on practical skills, guided learning, and real-world projects to help you become job-ready."
                            }
                            ctabtn1={
                                {
                        ...
                        <CodeBlocks
                            ...
                            heading={
                                <div className="w-[100%] text-3xl lg:text-4xl font-semibold lg:w-[50%]">
                                    Start
                                    <HighlightText text={"building in seconds"} />
                                </div>
                            }
                            subheading={
                              "Jump into hands-on learning instantly and start building real projects from your very first lesson."
                            }
                            ctabtn1={{
