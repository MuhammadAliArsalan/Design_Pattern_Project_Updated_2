      ...
      <div className='flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 items-center'>
        ...
        <div className='lg:w-[50%] flex flex-col'>
          ...
          <p className='font-medium text-[16px] w-[80%] text-richblack-300 mb-12'>
            Share your knowledge with students across Pakistan and beyond.
            StudyNotion gives you the tools to create courses, teach skills, and build an impact by helping others learn and grow in tech.
          </p>
