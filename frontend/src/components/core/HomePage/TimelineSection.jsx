...
const timeline = [
  {
    Logo: Logo1,
    heading: "Leadership",
    Description: "We focus on guiding students toward real-world tech skills and career growth.",
  },
  {
    Logo: Logo2,
    heading: "Student First Approach",
    Description: "Every feature is designed keeping students’ learning experience as the top priority.",
  },
  {
    Logo: Logo3,
    heading: "Flexibility",
    Description: "Learn anytime, anywhere with self-paced structured learning paths.",
  },
  {
    Logo: Logo4,
    heading: "Problem Solving",
    Description: "Build logic and solve real-world problems through hands-on coding practice.",
  },
];
