...
import { finalizeStripeCheckout } from "../../../services/operations/studentFeaturesAPI";
...
export default function EnrolledCourses() {
  ...
  const handledStripeSession = useRef(false);
  ...
  useEffect(() => {
    ...
    if (!sessionId || !token || handledStripeSession.current) return;

    handledStripeSession.current = true;
    finalizeStripeCheckout(token, sessionId, navigate, dispatch);
